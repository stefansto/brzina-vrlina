<?php
    ...
    if (isset($_POST['idDeny'])){
        $idDeny = $_POST['idDeny'];
        $deny = prijava("prijave", "odobreno", 0, "idPrijava", $idDeny);
    ...
    //Edit trkaca konkretno poslatoEditTrkac,poslatoEditId,poslatoEditIme,poslatoEditAlt, poslatoEditOpis,poslatoEditLink1

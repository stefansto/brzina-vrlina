    ...
    <div class="table-responsive">
      <table class="table table-dark table-striped table-sm">
        ...
        <tbody id="adminKorisnici">
          <?php
            //ispis tabele korisnici -> idKorisnik ,userKorisnik mailKorisnik passKorisnik roleKorisnik datumRegKorisnik
    ...
    <div class="table-responsive">
      <table class="table table-dark table-striped table-sm">
        ...
        <tbody id="adminPrijave">
          <?php
            //ispis tabele prijave -> idPrijave ,idKorisnik, vreme, link, komentar, odobreno idApprove idDeny
